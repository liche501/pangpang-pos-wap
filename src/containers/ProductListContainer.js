                            ...
                            <tr>
                                <td>
                                    <div style={styles.img}>
                                        {rowData.images && rowData.images.small?<img style={{ height: '1.28rem',width:'1.28rem',border: '0.5px solid gray',margin:'0.01rem 0.3rem 0.01rem 0' }} src={rowData.images.small.url} alt="" />:''}
                                    </div>
                                </td>
...
styles = {
    img: {
        ...
        margin:'0.01rem 0.3rem 0.01rem 0'        
    },
    img1: {
        width: "50px",
        height: "50px"
